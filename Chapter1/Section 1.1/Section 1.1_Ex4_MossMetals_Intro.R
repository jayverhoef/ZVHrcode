...
# box around it
file_name = "figures/RedDog_Alaska"
pdf(file = paste0(file_name,'.pdf'), width = 11, height = 11)
  old.par = par(mar = c(0,0,0,0))
  plot(st_geometry(AKboundary))
  plot(st_geometry(CAKRboundary), add = TRUE, col = 'red')
...
pdf(file = paste0(file_name,'.pdf'), width = 15, height = 10)
  ...
  par(mar = c(0,1,1,0))
  plot(st_geometry(CAKRboundary), lwd = 2)
  plot(MOSSpreds[MOSSpreds$strat==1,], 
		add = TRUE, pch = 19, cex = .2, col=pal[1])
  plot(MOSSpreds[MOSSpreds$strat==2,], 
		add = TRUE, pch = 19, cex = .2, col=pal[2])
  plot(MOSSpreds[MOSSpreds$strat==3,], 
		add = TRUE, pch = 19, cex = .2, col=pal[3])
  plot(MOSSpreds[MOSSpreds$strat==4,], 
		add = TRUE, pch = 19, cex = .5, col=pal[6])
  plot(MOSSpreds[MOSSpreds$strat==5,], 
		add = TRUE, pch = 19, cex = 1, col=pal[7])
...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
#          Lead Concentration as Distance from Road
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
...
file_name = "figures/RedDog_DistRoad"
