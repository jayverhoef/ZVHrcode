sec_path = 'Rcode/Chapter9/Section 9.10/'
...
pdf(paste0(file_name,'.pdf'), width = 12, height = 12)
	...
	plot(0:5, loocv_lm_rmspe, ylim = c(lo, .9), pch = 19, cex = 3,
	...
	points(0:5, loocv_spml_rmspe, pch = 22, cex = 3)
	lines(0:5, loocv_spml_rmspe, lty = 2, lwd = 3)
	points(0:5, loocv_spreml_rmspe, pch = 24, cex = 3)
	lines(0:5, loocv_spreml_rmspe, lty = 3, lwd = 3)
	legend(2.3, .9, legend = c('Indep Model','Spatial MLE', 'Spatial REMLE'), 
	...
	plot(0:5, loocv_lm_pic90, ylim = c(lo, up), xlim = c(-.1, 5.1), pch = 19, 
		cex = 3, xlab = 'Order of Polynomial', ylab = 'Interval Coverage', 
		cex.lab = cex_lab, cex.axis = cex_axis, main = 'LOOCV PIC90', cex.main = cex_main)
	points(0:5, loocv_spml_pic90, pch = 22, cex = 5)
	points(0:5, loocv_spreml_pic90, pch = 24, cex = 5)
	lines(c(-.2,5.2),c(0.9,0.9), lty = 2, lwd = 2)
	legend(1.9, .96, legend = c('Indep Model','Spatial MLE', 'Spatial REMLE'), 
		pch = c(19,22,24), cex = 2.2)
	...
	points(0:5, nfold_spml_results[,3], pch = 22, cex = 3)
	points(0:5, nfold_spreml_results[,3], pch = 24, cex = 3)
	lines(c(-.2,5.2),c(0.9,0.9), lty = 2, lwd = 2)
	legend(1.9, .944, legend = c('Indep Model','Spatial MLE', 'Spatial REMLE'), 
		pch = c(19,22,24), cex = 2.2)
